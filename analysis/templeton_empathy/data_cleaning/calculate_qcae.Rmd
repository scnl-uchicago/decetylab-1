...
# Reverse code (assumes that numeric values in raw data correspond to likert scale ratings, not item scores)
...
output_data <- output_data %>% filter(!(is.na(vk_child_qcae_os) & (unique_id == "china_3021")))

# Remove duplicate entries with conflicting values from QCAE data
output_data <- output_data %>% filter(!(unique_id == "china_3030"| unique_id == "south_africa_2069" | unique_id == "south_africa_2108" | unique_id == "south_africa_2116" | unique_id == "south_africa_4885"))
