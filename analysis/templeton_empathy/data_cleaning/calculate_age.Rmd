...
combined_data <- combined_data %>% mutate(new_age=replace(calculated_age, unique_id == "canada_1042", 97))
combined_data <- combined_data %>% mutate(new_age=replace(calculated_age, unique_id == "canada_1201", 61))

combined_data <- combined_data %>% mutate(new_age=replace(calculated_age, unique_id == "jordan_47", 98))
combined_data <- combined_data %>% mutate(new_age=replace(calculated_age, unique_id == "jordan_56", 126))
combined_data <- combined_data %>% mutate(new_age=replace(calculated_age, unique_id == "jordan_101", 114))
 
combined_data <- combined_data %>% mutate(new_age=replace(calculated_age, unique_id == "south_africa_2015", 111))
combined_data <- combined_data %>% mutate(new_age=replace(calculated_age, unique_id == "south_africa_2020", 101))
combined_data <- combined_data %>% mutate(new_age=replace(calculated_age, unique_id == "south_africa_2089", 104))
combined_data <- combined_data %>% mutate(new_age=replace(calculated_age, unique_id == "south_africa_2114", 93))
combined_data <- combined_data %>% mutate(new_age=replace(calculated_age, unique_id == "south_africa_2140", 108))
combined_data <- combined_data %>% mutate(new_age=replace(calculated_age, unique_id == "south_africa_2152", 76))
combined_data <- combined_data %>% mutate(new_age=replace(calculated_age, unique_id == "south_africa_2181", 154))
combined_data <- combined_data %>% mutate(new_age=replace(calculated_age, unique_id == "south_africa_2216", 145))
combined_data <- combined_data %>% mutate(new_age=replace(calculated_age, unique_id == "south_africa_2237", 167))

combined_data <- combined_data %>% mutate(new_age=replace(calculated_age, unique_id == "turkey_44", 54))
combined_data <- combined_data %>% mutate(new_age=replace(calculated_age, unique_id == "turkey_55", 61))
combined_data <- combined_data %>% mutate(new_age=replace(calculated_age, unique_id == "turkey_109", 58))
combined_data <- combined_data %>% mutate(new_age=replace(calculated_age, unique_id == "turkey_150", 61))
combined_data <- combined_data %>% mutate(new_age=replace(calculated_age, unique_id == "turkey_156", 56))
combined_data <- combined_data %>% mutate(new_age=replace(calculated_age, unique_id == "turkey_175", 37))
combined_data <- combined_data %>% mutate(new_age=replace(calculated_age, unique_id == "turkey_436", 80))
combined_data <- combined_data %>% mutate(new_age=replace(calculated_age, unique_id == "turkey_439", 76))
combined_data <- combined_data %>% mutate(new_age=replace(calculated_age, unique_id == "turkey_539", 99))
combined_data <- combined_data %>% mutate(new_age=replace(calculated_age, unique_id == "turkey_553", 103))
combined_data <- combined_data %>% mutate(new_age=replace(calculated_age, unique_id == "turkey_570", 136))

combined_data <- combined_data %>% mutate(new_age=replace(calculated_age, unique_id == "usa_62", 105))
combined_data <- combined_data %>% mutate(new_age=replace(calculated_age, unique_id == "usa_235", 87))
combined_data <- combined_data %>% mutate(new_age=replace(calculated_age, unique_id == "usa_247", 89))
combined_data <- combined_data %>% mutate(new_age=replace(calculated_age, unique_id == "usa_321", 152))
combined_data <- combined_data %>% mutate(new_age=replace(calculated_age, unique_id == "usa_457", 92))
combined_data <- combined_data %>% mutate(new_age=replace(calculated_age, unique_id == "usa_462", 129))

write.csv(combined_data, "templeton_age_calculations.csv")
